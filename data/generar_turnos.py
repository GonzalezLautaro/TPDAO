            ...
            while fecha_actual < fecha_fin:
                ...
                if fecha_actual.weekday() == numero_dia_semana:
                    ...
                    while hora_actual < hora_fin_dt:
                        ...
                        query_insert = f"""INSERT INTO Turno (matricula, id_consultorio, id_agenda, fecha, hora_inicio, hora_fin, estado)
VALUES ({matricula}, {id_consultorio}, {id_agenda}, '{fecha_actual}', '{hora_inicio_turno}', '{hora_fin_turno}', 'Libre');"""
